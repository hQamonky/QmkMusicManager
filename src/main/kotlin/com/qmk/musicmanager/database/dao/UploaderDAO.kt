...
interface UploaderDAO {
    ...
    suspend fun addNewUploader(id: String, name: String, namingFormat: NamingFormat, platform: String): Uploader?
    suspend fun editUploader(id: String, namingFormat: NamingFormat): Boolean
