...
class DataManager(
    ...
    suspend fun addDefaultNamingRules() {
        ...
        namingRuleDAO.addNewNamingRule(replace = " ♦ Hardstyle Remix (Videoclip) ♦", replaceBy = "", priority = 2)
        namingRuleDAO.addNewNamingRule(replace = " [Videoclip]", replaceBy = "", priority = 2)
        ...
        namingRuleDAO.addNewNamingRule(replace = "【𝙻𝚈𝚁𝙸𝙲𝚂】", replaceBy = "", priority = 2)
